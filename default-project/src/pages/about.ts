...
export default function About() {
  const rational: [string, string][] = [
    ...
    // Dego vs. React Comparison - Feature 3: Load Times
    [
    ...
    // Dego vs. React Comparison - Feature 4: Developer Experience (Boilerplate Code)
    [
    ...
    // Dego vs. React Comparison - Feature 5: State Management
    [
