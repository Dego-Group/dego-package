export interface HTMLElementAttributes {
   ...
   */
  dataset?: Record<string, string> // Key-value store of data-* attributes
...
export function attr<T extends HTMLElementAttributes>(attributes: T): string {
  ...
  return Object.entries(filteredAttributes)
    .map(([, [key, value]]) => {
      return `${key}="${value}"`
    })
    .join(' ')
